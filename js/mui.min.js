...
function statisticsfun(name){
	mui.plusReady(function(){
		...
		var flagback = 0;
		mui.back = function(){//结束计时逻辑代码
			var endtime = new Date().getTime();
			var intervaltime = (endtime - starttime)/1000;
			var timeall = formatSeconds(intervaltime);
			console.log(name  +  timeall);
			plus.statistic.eventDuration( "leave", intervaltime, {name: timeall} );//统计
			old_back();
		}
		plus.webview.currentWebview().addEventListener( "popGesture", function(){
			flagback++;
			if(flagback == 1){//结束计时逻辑代码
				var endtime = new Date().getTime();
				var intervaltime = (endtime - starttime)/1000;
				var timeall = formatSeconds(intervaltime);
				console.log(name  +  timeall);
